...
from PointSearch.sites.lagou.es_lagou import LaGouJobIndex
...
class LaGouJobItem(scrapy.Item, MysqlItem, ElasticSearchItem):
    ...
    def clean_data(self):
        ...
        if match_obj1:
            ...
            self['work_years_min'] = 0
            self['work_years_max'] = int(match_obj4.group(1))
        elif match_obj5:
            self['work_years_min'] = int(match_obj4.group(1))
            self['work_years_max'] = int(match_obj4.group(1)) + 100
        else:
